...
\textbf{ann.maskrcnn.train} [\textbf{-esbn}] \textbf{training\_dataset}=name
...
\subsection*{DESCRIPTION}
\textstyleEmphasis{ann.maskrcnn.train} allows the user to train a~Mask R-CNN
...
\textbf{ann.maskrcnn.detect -} Detect features in images using a~Mask R-CNN
model.
...
\textbf{ann.maskrcnn.detect} [\textbf{-esbn}] \textbf{images\_directory}=name
