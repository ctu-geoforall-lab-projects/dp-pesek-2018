...
the channels - e.g. in RGB images, the last dimension of connections is always 3.
...
huge parameter reduction, by parameter sharing. The idea of parameter sharing raised 
...
It is generally resolved\footnote{Roots of \zk{CNN}s lie at the end of eighties, 
...
visual recognition including many diverse tasks, for more information and 
...
the 2010s, development of \zk{CNN}s was out of the main spotlight. Although there 
