...
but the breakthrough came in nineties.} that the history of succesful \zk{CNN}s 
...
vision progress with which are \zk{CNN}s inseperably connected. For the topic of 
