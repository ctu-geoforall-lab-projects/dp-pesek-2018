...
recommended to provide rasters in the~same resolution as the~ones used for
the~training. The~detection is done in the~\verb|ann.maskrcnn.detect| GRASS GIS 
